...
const LoginModal = ({ setShowLogin }) => {
  ...
  return (
    <div className="login-modal fixed top-0 left-0 w-full h-full bg-gray-800/60 bg-opacity-50 flex items-center justify-center z-999">
      <div className="modal-content w-1/3 bg-white p-4 rounded-lg shadow-lg flex flex-col justify-between items-center animate-zoomIn">
        ...
        <form className="login-form w-full flex flex-col items-center px-6">
